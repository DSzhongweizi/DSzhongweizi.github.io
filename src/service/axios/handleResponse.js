/*
 * @Author: DS
 * @Date: 2021-08-04 13:30:08
 * @LastEditTime: 2021-08-06 09:18:45
 * @LastEditors: DS
 * @Description: desc
 * @FilePath: \dmu-web\src\service\axios\handleResponse.js
 */
// 处理响应错误码
  ...
  // 返回一个带有code和msg属性的对象
    ...
    switch (code) {
      ...
      case 404:
        ...
        break
      case 412:
        msg = msg || '未找到有效session'
        break
      default:
        // msg = msg || err.response.data.msg
        break
    }
    return {
      code,
